...
To further help debug your tracker, we also provide some classes for visulization in VOT toolkit that is available in the [toolkit/vot/utilities /draw.py](https://github.com/votchallenge/toolkit/blob/master/vot/utilities/draw.py) directory , e.g. `DrawHandle`, `MatplotlibDrawHandle`, and `ImageDrawHandle`. Below is a simple example that illustrates how it works.
